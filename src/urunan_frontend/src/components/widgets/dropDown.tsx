...
interface DropDownPropsItem extends InputHTMLAttributes<HTMLInputElement> {
    name: string;
    label: string;
}
...
export function DropDown({ items, defaultLabel, onItemSelected, ...props }: DropDownProps) {
